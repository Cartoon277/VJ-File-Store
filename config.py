...
# Bot Information
API_ID = int(environ.get("API_ID", "28273838"))
...
DB_NAME = environ.get("DB_NAME", "cartoonist680")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002255000492"))
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://allupdate05.blogspot.com/2025/03/nothing.html") # For More Information Check Video On Yt - @Tech_VJ
